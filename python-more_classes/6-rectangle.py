...
A class Rectangle that tracks the number of instances
"""
...
class Rectangle:
    ...
    def __repr__(self):
        """Returns a string representation of the rectangle to recreate a new
          instance using eval()
    ...
    def __del__(self):
        """Detects instance deletion, prints a message, and decrements the
          instance counter"""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
